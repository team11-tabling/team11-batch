...
import com.tabling_batch.batch.dto.PopularShopDto;
import com.tabling_batch.batch.dto.ShopBookingCountDto;
import com.tabling_batch.batch.tasklet.InitializeShopTasklet;
...
public class PopularShopBatch {
  ...
  public Job popularShopJob(JobRepository jobRepository, PlatformTransactionManager transactionManager, DataSource dataSource) {
    return new JobBuilder("popularShopJob", jobRepository)
        .start(initializeShopStep(null, jobRepository,transactionManager))
  ...
  @Bean
  @JobScope
  public Step initializeShopStep(@Value("#{jobParameters[date]}") String date, JobRepository jobRepository, PlatformTransactionManager transactionManager) {
